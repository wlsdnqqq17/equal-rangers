...
class GameActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        problem1.setOnClickListener { openProblemActivity(problem1.text) }
        problem2.setOnClickListener { openProblemActivity(problem1.text) }
        problem3.setOnClickListener { openProblemActivity(problem1.text) }
    }

    private fun openProblemActivity(problemNumber: CharSequence) {
